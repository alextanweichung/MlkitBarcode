...
@Component({
   selector: 'app-backtoback-order-item',
   templateUrl: './backtoback-order-item.page.html',
   styleUrls: ['./backtoback-order-item.page.scss'],
   providers: [DatePipe, SearchItemService, { provide: 'apiObject', useValue: 'MobileBackToBackOrder' }]
})
