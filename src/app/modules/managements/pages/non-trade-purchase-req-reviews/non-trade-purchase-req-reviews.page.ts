...
@Component({
  selector: 'app-non-trade-purchase-req-reviews',
  templateUrl: './non-trade-purchase-req-reviews.page.html',
  styleUrls: ['./non-trade-purchase-req-reviews.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "mobileNonTradePurchaseReqReview" }]
})
export class NonTradePurchaseReqReviewsPage implements OnInit {
