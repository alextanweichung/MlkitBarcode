...
@Component({
  selector: 'app-non-trade-purchase-order-approvals',
  templateUrl: './non-trade-purchase-order-approvals.page.html',
  styleUrls: ['./non-trade-purchase-order-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "mobileNonTradePurchaseOrderApprove" }]
})
export class NonTradePurchaseOrderApprovalsPage implements OnInit {
