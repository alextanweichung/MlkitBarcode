...
@Component({
  selector: 'app-inventory-processing-approvals',
  templateUrl: './inventory-processing-approvals.page.html',
  styleUrls: ['./inventory-processing-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileInventoryProcessingApprove" }]
})
export class InventoryProcessingApprovalsPage implements OnInit, ViewWillEnter {
