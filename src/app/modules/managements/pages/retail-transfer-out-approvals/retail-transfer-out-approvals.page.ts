...
@Component({
  selector: 'app-retail-transfer-out-approvals',
  templateUrl: './retail-transfer-out-approvals.page.html',
  styleUrls: ['./retail-transfer-out-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileTransferOutApprove" }]
})
export class RetailTransferOutApprovalsPage implements OnInit, ViewWillEnter {
