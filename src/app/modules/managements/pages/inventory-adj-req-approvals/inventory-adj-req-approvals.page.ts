...
@Component({
  selector: 'app-inventory-adj-req-approvals',
  templateUrl: './inventory-adj-req-approvals.page.html',
  styleUrls: ['./inventory-adj-req-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileInventoryAdjustmentReqApprove" }]
})
export class InventoryAdjReqApprovalsPage implements OnInit, ViewWillEnter {
