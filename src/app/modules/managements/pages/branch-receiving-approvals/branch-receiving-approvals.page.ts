...
@Component({
  selector: 'app-branch-receiving-approvals',
  templateUrl: './branch-receiving-approvals.page.html',
  styleUrls: ['./branch-receiving-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "mobileBranchReceivingApprove" }]
})
export class BranchReceivingApprovalsPage implements OnInit, ViewWillEnter {
