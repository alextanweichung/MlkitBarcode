...
@Component({
  selector: 'app-defect-request-approvals',
  templateUrl: './defect-request-approvals.page.html',
  styleUrls: ['./defect-request-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileDefectRequestApprove" }]
})
export class DefectRequestApprovalsPage implements OnInit, ViewWillEnter {
