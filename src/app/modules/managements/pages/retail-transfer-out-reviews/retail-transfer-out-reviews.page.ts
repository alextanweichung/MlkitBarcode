...
@Component({
  selector: 'app-retail-transfer-out-reviews',
  templateUrl: './retail-transfer-out-reviews.page.html',
  styleUrls: ['./retail-transfer-out-reviews.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileTransferOutReview" }]
})
export class RetailTransferOutReviewPage implements OnInit, ViewWillEnter {
