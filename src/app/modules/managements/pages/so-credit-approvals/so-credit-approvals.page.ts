...
@Component({
  selector: 'app-so-credit-approvals',
  templateUrl: './so-credit-approvals.page.html',
  styleUrls: ['./so-credit-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileSoCreditApprove" }]
})
export class SoCreditApprovalsPage implements OnInit, ViewWillEnter {
