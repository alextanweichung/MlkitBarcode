...
@Component({
  selector: 'app-recall-deposit-approvals',
  templateUrl: './recall-deposit-approvals.page.html',
  styleUrls: ['./recall-deposit-approvals.page.scss'],
  providers: [PosApprovalProcessingService, { provide: "apiObject", useValue: "MobileRecallDepositApprove" }]
})
export class RecallDepositApprovalsPage implements OnInit, ViewWillEnter {
