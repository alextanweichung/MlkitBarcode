...
@Component({
  selector: 'app-non-trade-purchase-order-reviews',
  templateUrl: './non-trade-purchase-order-reviews.page.html',
  styleUrls: ['./non-trade-purchase-order-reviews.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "mobileNonTradePurchaseOrderReview" }]
})
export class NonTradePurchaseOrderReviewsPage implements OnInit {
