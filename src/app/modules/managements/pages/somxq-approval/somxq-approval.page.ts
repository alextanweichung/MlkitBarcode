...
@Component({
  selector: 'app-somxq-approval',
  templateUrl: './somxq-approval.page.html',
  styleUrls: ['./somxq-approval.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "mobileMaxQtyApprove" }]
})
export class SomxqApprovalPage implements OnInit, ViewWillEnter {
