...
@Component({
  selector: 'app-b2b-credit-approvals',
  templateUrl: './b2b-credit-approvals.page.html',
  styleUrls: ['./b2b-credit-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileB2bCreditApprove" }]
})
export class B2bCreditApprovalsPage implements OnInit, ViewWillEnter {
