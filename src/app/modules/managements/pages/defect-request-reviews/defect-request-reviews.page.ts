...
@Component({
  selector: 'app-defect-request-reviews',
  templateUrl: './defect-request-reviews.page.html',
  styleUrls: ['./defect-request-reviews.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileDefectRequestReview" }]
})
export class DefectRequestReviewsPage implements OnInit, ViewWillEnter {
