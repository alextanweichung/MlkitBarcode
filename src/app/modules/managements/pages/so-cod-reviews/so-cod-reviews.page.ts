...
@Component({
  selector: 'app-so-cod-reviews',
  templateUrl: './so-cod-reviews.page.html',
  styleUrls: ['./so-cod-reviews.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileSoCodReview" }]
})
export class SoCodReviewsPage implements OnInit, ViewWillEnter {
