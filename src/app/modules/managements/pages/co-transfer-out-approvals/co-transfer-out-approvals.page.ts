...
@Component({
  selector: 'app-co-transfer-out-approvals',
  templateUrl: './co-transfer-out-approvals.page.html',
  styleUrls: ['./co-transfer-out-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileCoTransferOutApprove" }]
})
export class CoTransferOutApprovalsPage implements OnInit, ViewWillEnter {
