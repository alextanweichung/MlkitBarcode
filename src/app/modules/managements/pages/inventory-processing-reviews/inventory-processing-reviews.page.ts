...
@Component({
   selector: 'app-inventory-processing-reviews',
   templateUrl: './inventory-processing-reviews.page.html',
   styleUrls: ['./inventory-processing-reviews.page.scss'],
   providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileInventoryProcessingReview" }]
})
export class InventoryProcessingReviewsPage implements OnInit, ViewWillEnter {
