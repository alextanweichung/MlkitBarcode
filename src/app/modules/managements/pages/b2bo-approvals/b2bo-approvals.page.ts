...
@Component({
  selector: 'app-b2bo-approvals',
  templateUrl: './b2bo-approvals.page.html',
  styleUrls: ['./b2bo-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileBackToBackOrderApprove" }]
})
export class B2boApprovalsPage implements OnInit, ViewWillEnter {
