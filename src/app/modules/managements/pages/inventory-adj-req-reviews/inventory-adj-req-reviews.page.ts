...
@Component({
  selector: 'app-inventory-adj-req-reviews',
  templateUrl: './inventory-adj-req-reviews.page.html',
  styleUrls: ['./inventory-adj-req-reviews.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileInventoryAdjustmentReqReview" }]
})
export class InventoryAdjReqReviewsPage implements OnInit, ViewWillEnter {
