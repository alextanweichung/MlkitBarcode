...
@Component({
  selector: 'app-co-transfer-out-reviews',
  templateUrl: './co-transfer-out-reviews.page.html',
  styleUrls: ['./co-transfer-out-reviews.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileCoTransferOutReview" }]
})
export class CoTransferOutReviewPage implements OnInit, ViewWillEnter {
