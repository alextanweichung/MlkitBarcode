...
@Component({
  selector: 'app-b2b-cod-reviews',
  templateUrl: './b2b-cod-reviews.page.html',
  styleUrls: ['./b2b-cod-reviews.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileB2bCodReview" }]
})
export class B2bCodReviewsPage implements OnInit, ViewWillEnter {
