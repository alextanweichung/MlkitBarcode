...
@Component({
  selector: 'app-so-cod-approvals',
  templateUrl: './so-cod-approvals.page.html',
  styleUrls: ['./so-cod-approvals.page.scss'],
  providers: [TransactionProcessingService, { provide: "apiObject", useValue: "MobileSoCodApprove" }]
})
export class SoCodApprovalsPage implements OnInit, ViewWillEnter {
