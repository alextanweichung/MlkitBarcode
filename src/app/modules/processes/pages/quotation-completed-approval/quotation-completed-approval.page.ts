...
@Component({
  selector: 'app-quotation-completed-approval',
  templateUrl: './quotation-completed-approval.page.html',
  styleUrls: ['./quotation-completed-approval.page.scss'],
  providers: [TransactionProcessingService, { provide: 'apiObject', useValue: 'mobileQuotationApprove' }]
})
export class QuotationCompletedApprovalPage implements OnInit {
