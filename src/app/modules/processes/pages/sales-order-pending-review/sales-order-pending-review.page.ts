...
@Component({
  ...
  templateUrl: './sales-order-pending-review.page.html',
  styleUrls: ['./sales-order-pending-review.page.scss'],
  providers: [TransactionProcessingService, { provide: 'apiObject', useValue: 'mobileSalesOrderReview' }]
})
export class SalesOrderPendingReviewPage implements OnInit {
