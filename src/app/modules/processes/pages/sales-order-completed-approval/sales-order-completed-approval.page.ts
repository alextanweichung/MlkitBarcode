...
@Component({
  selector: 'app-sales-order-completed',
  templateUrl: './sales-order-completed-approval.page.html',
  styleUrls: ['./sales-order-completed-approval.page.scss'],
  providers: [TransactionProcessingService, { provide: 'apiObject', useValue: 'mobileSalesOrderApprove' }]
})
export class SalesOrderCompletedApprovalPage implements OnInit {
