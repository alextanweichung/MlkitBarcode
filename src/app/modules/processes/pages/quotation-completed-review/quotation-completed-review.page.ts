...
@Component({
  selector: 'app-quotation-completed-review',
  templateUrl: './quotation-completed-review.page.html',
  styleUrls: ['./quotation-completed-review.page.scss'],
  providers: [TransactionProcessingService, { provide: 'apiObject', useValue: 'mobileQuotationReview' }]
})
export class QuotationCompletedReviewPage implements OnInit {
